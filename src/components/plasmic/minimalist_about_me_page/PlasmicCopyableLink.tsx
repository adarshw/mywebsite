...
import * as sty from "./PlasmicCopyableLink.module.css"; // plasmic-import: zZ_gyxt9mSZuQ/css
...
function PlasmicCopyableLink__RenderFunc(props: {
  ...
  dataFetches?: PlasmicCopyableLink__Fetches;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(defaultcss.all, sty.freeBox___2Llpl)}>
          {p.renderPlasmicSlot({
